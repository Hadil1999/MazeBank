...
public class MainWindowControllerAdmin implements Initializable {

    static AnchorPane staticContent;
    private static MainWindowControllerAdmin instance;
    ...
    public static MainWindowControllerAdmin getInstance() {
        if (instance == null) {
            instance = new MainWindowControllerAdmin();
        }
        return instance;
    }

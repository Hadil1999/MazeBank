...
public class MainWindowControllerClient implements Initializable {

    static AnchorPane staticContent;
    private static MainWindowControllerClient instance;
    ...
    public static MainWindowControllerClient getInstance() {
        if (instance == null) {
            instance = new MainWindowControllerClient();
        }
        return instance;
    }
